' Callback routine for the ribbon button
Sub OnConvertChartData(control As IRibbonControl)
    ' Calls the main macro to convert chart data
    ConvertChartDataToValues
End Sub
